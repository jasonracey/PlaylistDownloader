...
public class DestinationPathBuilderTest
{
    ...
    {
        Assert.Throws<ArgumentNullException>(() => _destinationPathBuilder = new DestinationPathBuilder(null!, _mockFileWrapper.Object));
        Assert.Throws<ArgumentNullException>(() => _destinationPathBuilder = new DestinationPathBuilder(_mockDirectoryWrapper.Object, null!)); 
        Assert.IsNotNull(_destinationPathBuilder = new DestinationPathBuilder(_mockDirectoryWrapper.Object, _mockFileWrapper.Object));
    }
    ...
    public void ReturnsExpectedDestinationPath()
    {
        ...
        const string sourcePath = $"https://www.mock.com/{albumName}/{fileName}";
    ...
    public void MakesCertainDestinationDirectoryExists()
    {
        ...
        var destinationPathBase = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile);
        var fullDestinationPath = Path.Combine(destinationPathBase, $"Downloads{Path.DirectorySeparatorChar}{albumName}");
